...
function CreateAccountF() {
	...
	const singUp = async (data) => {
		const x = await axios(`${base}/api/v1/users/sign-up`, {
			method: "post",
			headers: {
			...
			<div className="space-y-6 basis-2/4 lg:pr-[8%]">
				...
				<div className="text-center space-y-4 mb-12">
					...
					<p className=" text-center text-xs leading-5 tracking-wide">
						By entering you will be able to know the status of your
						orders, the products saved in your Wishlist and your
						Jackie Club Points available to exchange for discounts.
					</p>
				</div>
				<form
					className="space-y-6"
				...
				>
					...
					<div className="flex items-start flex-col gap-2">
						...
						<div className=" text-red-500 text-xs">
							{signUpErrors.password &&
								signUpErrors.password.type === "minLength" &&
					...
					<div className="flex gap-12">
						...
						>
							create account {isPending && <SpinnerMini />}
						</button>
						<button
							type="submit"
							onClick={(e) => {
